...
public class ECSPerformanceTest_5Server_FIFO5 extends TestCase {
    ...
    // System.out.println("Throughput (50/50 5 Servers/FIFO 50/1 client): " +
    // throughput + " KB/s");
    // System.out.println("Latency (50/50 5 Servers/FIFO 50/1 client) : " + latency
    // + " ms");
    ...
    // try{
    // totalBytes = loops * ((1 * value.getBytes("UTF-8").length) +
    // 4*(output.getBytes("UTF-8").length));
    // }
    // catch (Exception e){
    // ex = e;
    // }
    ...
    // System.out.println("Throughput (20 puts/80 gets 5 Servers/FIFO 50/1 client):
    // " + throughput + " KB/s");
    // System.out.println("Latency (20 puts/80 gets 5 Servers/FIFO 50/1 client) : "
    // + latency + " ms");
    ...
    // try{
    // totalBytes = loops * ((4 * value.getBytes("UTF-8").length) +
    ...
    // System.out.println("Throughput (80put/20get 5 Servers/FIFO 50/5 client): " +
    // throughput + " KB/s");
    // System.out.println("Latency (80put/20get 5 Servers/FIFO 50/5 client) : " +
    // latency + " ms");
    ...
    // System.out.println("Throughput (50/50 5 Servers/FIFO 50/5 client): " +
    // throughput + " KB/s");
    // System.out.println("Latency (50/50 5 Servers/FIFO 50/5 client) : " + latency
    // + " ms");
    ...
    // System.out.println("Throughput (20 puts/80 gets 5 Servers/FIFO 50/5 client):
    // " + throughput + " KB/s");
    // System.out.println("Latency (20 puts/80 gets 5 Servers/FIFO 50/5 client) : "
    // + latency + " ms");
    ...
    // System.out.println("Throughput (80put/20get 5 Servers/FIFO 50/20 client): " +
    // throughput + " KB/s");
    // System.out.println("Latency (80put/20get 5 Servers/FIFO 50/20 client) : " +
    // latency + " ms");
    ...
    // System.out.println("Throughput (50/50 5 Servers/FIFO 50/20 client): " +
    // throughput + " KB/s");
    // System.out.println("Latency (50/50 5 Servers/FIFO 50/20 client) : " + latency
    // + " ms");
    ...
    // System.out.println("Throughput (20 puts/80 gets 5 Servers/FIFO 50/20 client):
    // " + throughput + " KB/s");
    // System.out.println("Latency (20 puts/80 gets 5 Servers/FIFO 50/20 client) : "
    // + latency + " ms");
