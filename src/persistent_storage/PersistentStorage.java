...
public class PersistentStorage implements IPersistentStorage {
  ...
  public synchronized boolean delete(String key) {
    try {
      /**
       * The method returns the value that was previously mapped to the specified key if the key
       * exists, otherwise the method returns NULL.
       */
  ...
  public synchronized boolean existsCheck(String key) {
    if (this.referenceMap.isEmpty()) {
       ...
       * being mapped into the HashMap or not. It takes the key element as a parameter and returns
