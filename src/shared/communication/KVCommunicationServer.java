...
public class KVCommunicationServer extends KVCommunicationClient implements Runnable {
   ...
   * @return Message to return to client, which should indicate whether the request was successful
   *     or not
   */
    ...
    switch (msg.getStatus()) {
      case GET:
        ...
        try {
          ...
          logger.info(
              String.format("%s: %s, %s", returnMsgType.toString(), msgKey, returnMsgValue));
        } catch (Exception e) {
